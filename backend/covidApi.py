...
def findCovidCasesPerHund(population, county):
    ...
    nowCases=float(getDataFromDate(returnCounty("US", str(county)), date1day))
    thenCases=float(getDataFromDate(returnCounty("US", str(county)), date2day))
